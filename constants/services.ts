  ...
  const services: Array<TService> = [
    {
      algorithm: [
        ...
        "Ми проводимо консультацію. Після неї Ви отримуєте список необхідних дій та колаж із декором, меблями та іншими дрібницями для Вашої оселі.",
    ...
    },
    {
      algorithm: [
        ...
        "Розповідаєте який функціонал приміщення, що Вам не подобається зараз, чого б хотіли та чого очікуєте від співпраці.",
        "Разом із декоратором вибираєте стилістику, що саме подобається та бюджет на зміни.",
        "Також Ви можете замовити послугу офлайн та зустрітися з нами на об’єкті.",
        "Після цього декоратор робить муд борд, колаж та презентує свою ідею. Тривалість цього процесу 2-4 дні.",
        ...
        "Усі кроки може виконати декоратор, це віришується на початку співпраці.",
      ],
      description:
    ...
    {
      algorithm: [
        "Ви пишете нам свої побажання: підбір посуду, аксесуарів, текстилю та девайсів з нуля або розбір уже наявного посуду.",
        "Потім ми проводимо консультацію, вирішуємо у якому напрямі рухаємось, обговорюємо бюджет на зміни і починаємо роботу.",
        "Якщо у Вас вже є столовий гардероб, ми можемо його змінити або доповнити та зробити для Вас сервірувальні сети.",
